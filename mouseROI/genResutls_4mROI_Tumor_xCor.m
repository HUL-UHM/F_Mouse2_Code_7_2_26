...
saveFig=1;
%% 
% mpT='H:\Mouse2\2026.02.16\37_53_Red_D4\MARDI\Fun\T_76_Fs_2\f100_n10_nC4_PRF10_PI\';
% main_path=fullfile(mpT,'Fac_2_HP_4_6_5_nC_4_24-February-2026_10-40-19');
% figName='25_HARF_x2f1Fac_2_HP_4_6_5_nC_4_Pos1_Ac1.fig';
% yLV=[8 26]; xLV=[-10 10];%change
...
hFSlope1='xCorL41p5rF0rF0FiltLinFit_25_01.mat';
hFSlope2='xCorL41p5rF0rF0FiltLinFit_25_01.mat';
roiName='ROI_Final_R';
LogThreshold=-60;
addLogThresh=10;
saveImPath=fullfile(main_path,'Process_Fun','filtDisp2D','Results_xCor_R');
...
for fTot=1:size(avgData1,3)+3
    ...
    elseif fTot==11
         data_med1=nanmedfilt2(max(diff(dataF1(:,:,1:26),1,3),[],3),kerN);
         data_med2=nanmedfilt2(max(diff(dataF2(:,:,1:26),1,3),[],3),kerN);
         tName='PV   ';
    elseif fTot==12
