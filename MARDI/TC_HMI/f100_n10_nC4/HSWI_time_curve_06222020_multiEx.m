...
Ncycle=4;flagLoad=3; % 2=equal distant push; 1 = previous location;
                 % else point sel
folName=['f',num2str(funFreq),'_n',num2str(totalHarm),'_nC',num2str(Ncycle)];
...
filePath='G:\AblationStudy\02142022\L74\ST-HMI\01312022\f100_n10_nC4';
fileName='f1Fac_2_HP_2_2_6_nC_6.mat';
%%
...
save(saveName,'note','indPush_mod','indPush','nPush','push_cycle','funFreq',...
        'track_btwn_num','pushFreq','pushDuration_all','PRF','relaxationTimeTrack','total_time',...
        'on_duration','relaxationTime','Duty_C','Ncycle','pushLocT','fftAmpFreq','freqLoc','Dmin','Dmax')
